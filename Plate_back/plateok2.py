...
IMG_PATH_TOP = "Foto_Plates_2/Tale_Maly_01_T.jpg"
IMG_PATH_SIDE = "Foto_Plates_2/Tale_Maly_01_L.jpg"

# Tu dla małego talerza i miseczki jest idealnie
...
<CASE_PLATE>
    ...
    1. ANALIZA RANTU: Sprawdź krawędź. Jeśli widzisz wzór (romby, paski, dekoracje) - to JEST część talerza.
    2. POMIAR: Mierz od zewnętrznego końca wzoru z lewej do zewnętrznego końca wzoru z prawej.
    3. ZAKAZY: Ignoruj biały środek. NIE stosuj korekty perspektywy (talerz jest płaski).
</CASE_PLATE>

<CASE_BOWL>
    CEL: Realna średnica otworu (skorygowana o perspektywę).
    1. POMIAR WSTĘPNY: Zmierz wizualną szerokość otworu na zdjęciu z góry.
    2. KOREKTA PERSPEKTYWY: Górna krawędź miski jest bliżej kamery niż dno, co sztucznie powiększa wynik.
    3. OBLICZENIE: wykonuj WYŁĄCZNIE DLA BOWL Odejmij 19% od wizualnego pomiaru.
       (Formuła: Wynik_Końcowy = Wizualna_Szerokość * 0.81).
</CASE_BOWL>
